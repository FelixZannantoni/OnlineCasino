...
- Gegenüber einem klassischem Kasino "24/7 Verfügbarkeit" 
- Von überall aus
...
![Mindmap](OnlineCasino_MindMap.jpg)


## 3. Chancen und Risiken
- **S**trenghts
  - Hohe Motivation im Team
  - Klare Rolen-Verteilung
- **W**eaknesses:
  - Zeitdruck
  - Erstes großes Projekt -> unerfahren
- **O**pportunities
  - Sammeln von Erfahrungen
  - Eventuel Geld verdienen
- **T**hreats:
...
## 4. Planung
- Priorisierung der geplanten Features:
  ...
  Milestone 
  1. Ostern funktionierender Grundsatz (ersten Spiele spielbar und grobe Benutzeroberfläche) 
  2. Mai weitere Funktionen und Features + anschauliches UI/UX
  3. Juni Polishing und Fertigstellung, eventuelle Monitization
