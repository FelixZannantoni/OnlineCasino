...
export const MODE_CONFIG: ModeConfig[] = [
  {
    ...
    description: 'Kleine Einsätze, entspanntes Spielen – perfekt zum Aufwärmen.',
    minBet: '10 Chips',
    maxBet: '500 Chips',
    color: '#4caf50',
  },
  {
    ...
    icon: 'trending_up',
    tagline: 'Balanced',
    description: 'Ausgewogenes Risiko für erfahrene Spieler, die es spannend mögen.',
    minBet: '100 Chips',
    maxBet: '2.500 Chips',
    color: '#ff9800',
  },
  {
    ...
    tagline: 'High Stakes',
    description: 'Alles oder nichts – nur für hartgesottene Risikospieler.',
    minBet: '500 Chips',
    maxBet: '10.000 Chips',
    color: '#f44336',
  },
